            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="row d-flex justify-content-center">
                        ...
                        @endif
                        <div class="col-lg-12">
                            @if($konfigurasi->nama_upt == null || $konfigurasi->logo_upt == null || $konfigurasi->logo_stempel == null)
                                ...
                                <div class="card border-top-info p-4">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="nama_upt" value="{{old('nama_upt')}}" placeholder="Nama UPT" class="mb-3 form-control @error('nama_lengkap') is-invalid @enderror">
                                            @error('nama_upt')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
